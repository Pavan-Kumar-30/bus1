                        ...
                        <tbody>
                            ...
                            while ($fetch = $row->fetch_assoc()) {
                                ...
                                <td><?php $array = getTotalBookByType($id);
                                        echo ($max_first = ($array['first'] - $array['first_booked'])), " Seat(s) Available for Girls " . "<hr/>" . ($max_second = ($array['second'] - $array['second_booked'])) . " Seat(s) Available for Boys";
                                        ?></td>
                                            ...
                                            <form action="<?php echo $_SERVER['PHP_SELF'] . "?loc=$id" ?>"
                                                ...
                                                <p>
                                                    Class : <select name="class" required class="form-control" id="">
                                                        ...
                                                        <option value="first">For Girls (₹
                                                            <?php echo ($fetch['first_fee']); ?>)</option>
                                                        <option value="second">For Boys (₹

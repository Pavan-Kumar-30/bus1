                                ...
                                <tbody>
                                    ...
                                    while ($fetch = $row->fetch_assoc()) {
                                        ...
                                        <td><?php $array = getTotalBookByType($id);
                                                echo (($array['first'] - $array['first_booked'])), " Seat(s) Available for Girls" . "<hr/>" . ($array['second'] - $array['second_booked']) . " Seat(s) Available for Boys";
                                                ?></td>
        ...
        <div class="modal-content" align="center">
            ...
            <div class="modal-body">
                <form action="" method="post">
                    ...
                    <div class="row">
                        <div class="col-sm-6">
                            Girls Fee : <input class="form-control" type="number" name="first_fee" required
                                id="">
                        </div>
                        <div class="col-sm-6">

                            Boys Fee : <input class="form-control" type="number" name="second_fee" required
                                id="">
                        </div>
                    </div>
                    <div class="row">
